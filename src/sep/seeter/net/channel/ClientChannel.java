 ...
 * exchange instances of {@link sep.seeter.net.message.Message} with the server.
 * These calls may be performed in any <i>sequence</i> (note:
...
public class ClientChannel implements AutoCloseable {
    ...
    /**
     * Allocate a new client channel object for communicating with an instance
     * of {@code sep.seeter.server.Server} listening at the specified host and
     * port.
     *
     ...
     * <p>
     * Guaranteed post condition: {@code !isOpen()}. This operation is
     * idempotent provided the other methods are not called.
     *
     * @throws IOException If an I/O error occurs
     */
    @Override
